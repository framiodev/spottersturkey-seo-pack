...
class WebAutoIndexController implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $secretKey = $this->settings->get('spottersturkey-seo.trigger_secret', '');
        ...
        // Yeni veya güncellenen konuları (sadece henüz ping atılmamış olanları) çek
        ...
        // Flarum mimarisinde gönderilme tarihi konular tablosuna (discussion) yazıldığı için,
        // Post'ları da çekerken üst konunun gönderilme durumunu filtrelemeliyiz.
        ...
        foreach ($posts as $post) {
            if ($post->discussion) {
                ...
                // Mührü konuya basalım ki bir sonraki seferde tekrar ping atmasın
