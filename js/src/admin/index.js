            ...
            m('div.SeoPack-Admin', [
                ...
                m('div.SeoContent', [
                    ...
                    this.activeTab === 'settings' ? m('div.SeoCard', [
                        ...
                        this.buildSettingComponent({ type: 'text', setting: 'spottersturkey-seo.ga_id', label: 'Google Analytics 4 Ölçüm Kimliği (G-XXXXXXXX)' }),
                        this.buildSettingComponent({ type: 'text', setting: 'spottersturkey-seo.ga_id_number', label: 'GA4 Mülk Kimliği (Sayısal ID - Dashboard İçin)' }),
                        this.buildSettingComponent({ type: 'text', setting: 'spottersturkey-seo.gsc_code', label: 'Google Search Console Doğrulama Kodu' }),
                        this.buildSettingComponent({ type: 'text', setting: 'spottersturkey-seo.ads_client', label: 'Google Ads Yayıncı Kimliği (ca-pub-XXXXXXXX)' }),
                        this.buildSettingComponent({ type: 'text', setting: 'spottersturkey-seo.meta_description_prefix', label: 'Site Açıklaması (Meta Description)' }),
                        this.buildSettingComponent({ type: 'text', setting: 'spottersturkey-seo.meta_keywords', label: 'Meta Anahtar Kelimeler' }),
                        this.buildSettingComponent({ type: 'text', setting: 'spottersturkey-seo.trigger_secret', label: 'Cron-Job.org Gizli Anahtarı (Tetikleme Şifresi)' }),
...
app.initializers.add('spottersturkey-seo-pack', () => {
    app.extensionData.for('spottersturkey-seo-pack').registerPage(SeoAdminPage);
});
